...
export const mockSolicitudesOperador: SolicitudOperador[] = [
  // ========== SOLICITUDES PENDIENTES DE APROBAR (enviada) ==========
  ...
  // Solicitud 1 - Urgente
  {
    ...
    prioridad: 'media',
    motivo: 'nueva_flota',
    justificacion: 'Renovación parcial de flota - 8 vehículos nuevos previstos para febrero 2026.',
    lineas: [
      {
        id: 'lin-001-1',
        productoId: 'EP-001',
  ...
  // Solicitud 2 - Urgente
  {
    ...
    prioridad: 'alta',
    motivo: 'sustitucion',
    justificacion: 'Antena con pérdida de señal GPS. Afecta al tracking del vehículo 354.',
  ...
  // Solicitud 3
  {
    ...
    prioridad: 'alta',
    motivo: 'nueva_flota',
    justificacion: 'Incorporación de 15 autobuses eléctricos nuevos para línea exprés aeropuerto.',
    lineas: [
      {
        id: 'lin-003-1',
        productoId: 'EP-001',
    ...
    fechaEnvio: sub(today, { days: 2 }),
    creadoPor: 'Operador TUSGSAL',
  },
  ...
  // Solicitud 4
  {
    ...
    prioridad: 'media',
    motivo: 'ampliacion',
    justificacion: 'Ampliación servicio línea Igualada-Barcelona. 6 vehículos adicionales.',
    lineas: [
      {
        id: 'lin-004-1',
        productoId: 'EP-001',
    ...
    creadoPor: 'Operador HIFE',
  },

  // Solicitud 5 - Urgente incidencia
  {
    id: 'sol-005',
    ...
    prioridad: 'critica',
    motivo: 'incidencia',
    justificacion: 'Switch ethernet dañado por cortocircuito. Bus 412 fuera de servicio.',
    vehiculosAfectados: ['VEH-ALSINA-412'],
    lineas: [
      {
        id: 'lin-005-1',
        productoId: 'EP-002',
    ...
    estado: 'enviada',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { hours: 2 }),
    fechaEnvio: sub(today, { hours: 2 }),
  ...
  // Solicitud 6
  {
    ...
    operadorId: 'op-41',
    operadorNombre: 'TEISA',
    tipo: 'normal',
    prioridad: 'media',
    motivo: 'nueva_flota',
    justificacion: 'Renovación flota líneas interurbanas Girona. 10 vehículos nuevos.',
    lineas: [
      {
        id: 'lin-006-1',
        productoId: 'EP-001',
    ...
    estado: 'enviada',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { days: 4 }),
    fechaEnvio: sub(today, { days: 4 }),
    creadoPor: 'Operador TEISA',
  },
  ...
  // Solicitud 7
  {
    ...
    prioridad: 'alta',
    motivo: 'nueva_flota',
    justificacion: 'Flota de 12 buses híbridos nuevos para Sabadell - entrega Q1 2026.',
    lineas: [
      {
        id: 'lin-007-1',
        productoId: 'EP-001',
  ...
  // Solicitud 8
  {
    ...
    prioridad: 'baja',
    motivo: 'ampliacion',
    justificacion: 'Equipamiento adicional para 4 vehículos sin sistema T-movilitat.',
    lineas: [
      {
        id: 'lin-008-1',
        productoId: 'EP-001',
    ...
    estado: 'enviada',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { days: 6 }),
    fechaEnvio: sub(today, { days: 6 }),
  ...
  // Solicitud 9
  {
    ...
    estado: 'enviada',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { days: 7 }),
    fechaEnvio: sub(today, { days: 7 }),
    creadoPor: 'Operador Julià',
  },

  // Solicitud 10 - Urgente
  {
    id: 'sol-010',
    ...
    prioridad: 'alta',
    motivo: 'sustitucion',
    justificacion: 'Kit integral dañado en accidente menor. Vehículo 127 necesita reparación.',
    vehiculosAfectados: ['VEH-PRAT-127'],
    lineas: [
      {
        id: 'lin-010-1',
        productoId: 'EP-003',
    ...
    estado: 'enviada',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { hours: 12 }),
    fechaEnvio: sub(today, { hours: 12 }),
    creadoPor: 'Operador Prat',
  },

  // ========== SOLICITUDES YA APROBADAS (para Central de Compras) ==========
  
  // Solicitud aprobada - pendiente de agregar a pedido
  {
    id: 'sol-011',
    codigo: 'SOL-2025-0011',
    operadorId: 'op-20',
    operadorNombre: 'TUSGSAL',
    tipo: 'normal',
    prioridad: 'media',
    motivo: 'ampliacion',
    justificacion: 'Ampliación línea L40 con 3 vehículos adicionales.',
    lineas: [
      {
        id: 'lin-011-1',
        productoId: 'EP-001',
    ...
    fechaEnvio: sub(today, { days: 15 }),
    fechaAprobacion: sub(today, { days: 12 }),
    creadoPor: 'Operador TUSGSAL',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
  },

  // Solicitud en pedido a WINFIN
  {
    id: 'sol-012',
    codigo: 'SOL-2025-0012',
    operadorId: 'op-24',
    operadorNombre: 'LA HISPANO IGUALADINA, SL',
    tipo: 'normal',
    prioridad: 'baja',
    motivo: 'ampliacion',
    justificacion: 'Equipamiento para 5 vehículos transferidos desde otra concesión.',
    lineas: [
      {
        id: 'lin-012-1',
        productoId: 'EP-001',
    ...
    fechaAprobacion: sub(today, { days: 22 }),
    creadoPor: 'Operador HIFE',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
  },

  // Solicitud servida desde stock (histórico)
  {
    id: 'sol-013',
    ...
    vehiculosAfectados: ['VEH-ALSINA-300'],
    lineas: [
      {
        id: 'lin-013-1',
        productoId: 'EP-002',
        ...
        cantidadAprobada: 1,
        cantidadEntregada: 1,
        vehiculosDestino: [{ vehiculoId: 'VEH-ALSINA-300', calca: '300', matricula: '6916-HCR', cantidad: 1 }],
      },
    ],
    ...
    fechaAprobacion: sub(today, { days: 10 }),
    fechaEntrega: sub(today, { days: 9 }),
    creadoPor: 'Operador Alsina',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
    notas: 'Servido desde stock de urgencias. Tiempo respuesta: 24h.',
  },

  // ========== SOLICITUDES ADICIONALES APROBADAS (para Central de Compras) ==========
  
  // Solicitud 14 - Aprobada, pendiente agregar a pedido
  {
    id: 'sol-014',
    codigo: 'SOL-2025-0014',
    operadorId: 'op-03',
    operadorNombre: 'AUTOCARS DEL PENEDÈS, SA',
    tipo: 'normal',
    prioridad: 'media',
    motivo: 'ampliacion',
    justificacion: 'Expansión de rutas escolares zona Vilafranca. 4 vehículos.',
    lineas: [
      {
        id: 'lin-014-1',
        productoId: 'EP-001',
    ...
    estado: 'aprobada',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { days: 14 }),
    fechaEnvio: sub(today, { days: 14 }),
    fechaAprobacion: sub(today, { days: 11 }),
    creadoPor: 'Operador Penedès',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
  },

  // Solicitud 15 - Aprobada, pendiente agregar
  {
    id: 'sol-015',
    codigo: 'SOL-2025-0015',
    operadorId: 'op-41',
    operadorNombre: 'TEISA',
    tipo: 'normal',
    prioridad: 'alta',
    motivo: 'nueva_flota',
    justificacion: 'Nueva licitación líneas Costa Brava. 8 buses articulados.',
    lineas: [
      {
        id: 'lin-015-1',
        productoId: 'EP-001',
  ...
  // Solicitud 16 - Asignada a pedido WINFIN
  {
    id: 'sol-016',
    codigo: 'SOL-2025-0016',
    operadorId: 'op-02',
    operadorNombre: 'AUTOCARES JULIÀ, SL',
    tipo: 'normal',
    prioridad: 'media',
    motivo: 'nueva_flota',
    justificacion: 'Renovación flota para rutas turísticas Barcelona. 6 vehículos nuevos.',
    lineas: [
      {
        id: 'lin-016-1',
        productoId: 'EP-001',
  ...
  // Solicitud 17 - En tránsito
  {
    id: 'sol-017',
    codigo: 'SOL-2025-0017',
    operadorId: 'op-13',
    operadorNombre: 'TUS, SCCL',
    tipo: 'normal',
    prioridad: 'alta',
    motivo: 'ampliacion',
    justificacion: 'Ampliación red urbana Sabadell. 10 vehículos adicionales.',
    lineas: [
      {
        id: 'lin-017-1',
        productoId: 'EP-001',
    ...
    estado: 'en_transito',
    pedidoProveedorId: 'ped-prov-002',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { days: 45 }),
    fechaEnvio: sub(today, { days: 45 }),
    fechaAprobacion: sub(today, { days: 43 }),
    creadoPor: 'Operador TUS',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
    notas: 'Enviado por WINFIN el 25/11. Llegada estimada: 10/12.',
  },

  // Solicitud 18 - Entregada
  {
    id: 'sol-018',
    ...
    prioridad: 'media',
    motivo: 'nueva_flota',
    justificacion: 'Adquisición de 3 microbuses para líneas rurales.',
    lineas: [
      {
        id: 'lin-018-1',
        productoId: 'EP-001',
    ...
    fechaEnvio: sub(today, { days: 60 }),
    fechaAprobacion: sub(today, { days: 58 }),
    fechaEntrega: sub(today, { days: 5 }),
    creadoPor: 'Operador Montferri',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
    notas: 'Material instalado correctamente en los 3 vehículos.',
  },

  // Solicitud 19 - Entregada
  {
    id: 'sol-019',
    ...
    prioridad: 'alta',
    motivo: 'nueva_flota',
    justificacion: 'Renovación completa línea aeropuerto A1. 7 vehículos.',
    lineas: [
      {
        id: 'lin-019-1',
        productoId: 'EP-001',
    ...
    pedidoProveedorId: 'ped-prov-002',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { days: 70 }),
    fechaEnvio: sub(today, { days: 70 }),
    fechaAprobacion: sub(today, { days: 68 }),
    fechaEntrega: sub(today, { days: 15 }),
    creadoPor: 'Operador Prat',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
  },

  // Solicitud 20 - En tránsito (urgente)
  {
    id: 'sol-020',
    ...
    prioridad: 'alta',
    motivo: 'sustitucion',
    justificacion: 'Reposición de 2 antenas dañadas por vandalismo.',
    vehiculosAfectados: ['VEH-HISPANO-201', 'VEH-HISPANO-205'],
    lineas: [
      {
        id: 'lin-020-1',
        productoId: 'EP-001',
    ...
    pedidoProveedorId: 'ped-prov-002',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { days: 30 }),
    fechaEnvio: sub(today, { days: 30 }),
    fechaAprobacion: sub(today, { days: 29 }),
    creadoPor: 'Operador Hispano',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
    notas: 'Prioridad alta por afectación servicio.',
  },

  // Solicitud 21 - Servida desde stock (urgente)
  {
    id: 'sol-021',
    ...
    prioridad: 'critica',
    motivo: 'incidencia',
    justificacion: 'Fallo crítico antena GPS en bus 501. Sin tracking.',
    vehiculosAfectados: ['VEH-TUSGSAL-501'],
    lineas: [
      {
        id: 'lin-021-1',
        productoId: 'EP-001',
        ...
        cantidadAprobada: 1,
        cantidadEntregada: 1,
        vehiculosDestino: [{ vehiculoId: 'VEH-TUSGSAL-501', calca: '501', matricula: '3421-JKL', cantidad: 1 }],
      },
    ],
    estado: 'servida_stock',
    servidaDesdeStock: true,
    fechaCreacion: sub(today, { days: 3 }),
    fechaEnvio: sub(today, { days: 3 }),
    fechaAprobacion: sub(today, { days: 3 }),
    fechaEntrega: sub(today, { days: 2 }),
    creadoPor: 'Operador TUSGSAL',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
    notas: 'Urgencia atendida en 24h desde stock.',
  },

  // Solicitud 22 - Asignada a pedido
  {
    id: 'sol-022',
    ...
    prioridad: 'media',
    motivo: 'ampliacion',
    justificacion: 'Ampliación servicio líneas nocturnas. 5 vehículos.',
    lineas: [
      {
        id: 'lin-022-1',
        productoId: 'EP-001',
    ...
    pedidoProveedorId: 'ped-prov-001',
    servidaDesdeStock: false,
    fechaCreacion: sub(today, { days: 22 }),
    fechaEnvio: sub(today, { days: 22 }),
    fechaAprobacion: sub(today, { days: 20 }),
    creadoPor: 'Operador Alsina',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
  },

  // Solicitud 23 - Aprobada (incidencia)
  {
    id: 'sol-023',
    ...
    prioridad: 'alta',
    motivo: 'incidencia',
    justificacion: 'Kit integral dañado por filtración de agua. Bus 312.',
    vehiculosAfectados: ['VEH-HIFE-312'],
    lineas: [
      {
        id: 'lin-023-1',
        productoId: 'EP-003',
    ...
    creadoPor: 'Operador HIFE',
    aprobadoPor: 'G.S.S. (Jefe de Proyecto)',
    notas: 'Se evaluará servir desde stock si hay disponibilidad.',
  },
];
